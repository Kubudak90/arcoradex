...
contract ArcoraDexPool is IArcoraDexPool, Ownable2Step, ReentrancyGuard {
    ...
    constructor(address registry, uint16 initialSwapFeeBps, uint16 initialProtocolFeeShareBps, address initialOwner)
    ...
    // ── Quote views ──────────────────────────────────────────────────
    function _grossOut(uint256 amountIn, uint256 priceIn1e18, uint256 priceOut1e18, uint8 decIn, uint8 decOut)
        internal
        pure
        returns (uint256)
    {
